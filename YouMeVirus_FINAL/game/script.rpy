...
default warren_kissed = False
default alexei_kissed = False
default honey_kissed = False
...
label before_main_menu:
    play music "<loop 0.0>menu.mp3"
    return

label start:
    stop music
    play music "<loop 0.0>happiness.mp3" 
...
label Warren_date:
    ...
    label date_end:
        if honey_end:
            ...
            "Even better, despite having a good immune system, Honey doesn't know any better about being wary around you. It's like no one taught him the basics of flu season!
...
label Coffee_shop:
    ...
    hide virus
    show alexei neutral
    play music "<loop 0.0>tomorrow.mp3"
    ...
    menu:
        "Cut in rudely":
            ...
            i "Oy! Cut it out! Don't talk that vaccine stuff out here! Are you trying to ruin everyone's lives?! Everyone knows the best way to fight off any sort of sickness is to turn your a/c on high and binge eat Coldrock ice-cream!"
        "Take him aside kindly":
            i "Hey! I couldn't help but overhear you. Would you mind sitting with me for a bit? Just to chat. You seem so friendly and sociable! So handsome! I bet you have a GREAT immune system too."
    show alexei neutral at right
    a "I'm always glad to meet one of my constituents. What can I do for you?"

    "Now that youve had a chance to look at him, you recognize Alexei as one of the most prominent up-and-coming politicians! Jackpot! Just from the look of him, you can tell hell be a perfect carrier for your strain, too!"
    ...
    menu:
        ...
        "Force him to party":
            ...
            a "I couldn't possibly go! There's too much work to be done!"
            show alexei angry at right
            show alexei neutral at right
            i "Forget work, you're going. Thats final."
        "Coerce him to party":
            i "You seem like a first class workaholic. When's the last time you took a break?"
            show alexei worried at right
            a "Now that you mention it...I'm not sure."
            show alexei neutral at right
            a "Maybe it's been too long"
            i "It definitely has. You're going with me to this party this weekend and I'm going to teach you about taking some \"me time\""
...
label party:
    scene bg party
    with fade
    play music "<loop 0.0>party.mp3"

    label the_choice:
        if alexei_kissed == False and warren_kissed == False and warren_end == False and alexei_end == False:
            jump ok_ending
        elif alexei_kissed == False and alexei_end == False and honey_end == False and honey_kissed == False:
            jump ok_ending
        else:
            hide warren
            hide honey
            ...
            menu:
                ...
                "Warren, the pretty-boy party planner" if warren_end and not warren_kissed:

                    jump party_planner
                "Alexei, the white-hot witty workaholic" if alexei_end and not alexei_kissed:

                    jump white_hot_workaholic
                "Honey Bear, the real party royalty" if honey_end and not honey_kissed:
    ...
    label party_royalty:
        ...
        h "Oh. My. Bio! InFLU I don't know what to do. My family is horrid./n
    ...
    label ok_ending:
        if honey_end and warren_end and honey_kissed and warren_kissed and not alexei_kissed:
            stop music fadeout 1.0
            play music "creep.mp3"
            ...
            stop music fadeout 1.0
            return
        elif honey_end and alexei_end and honey_kissed and alexei_kissed and not warren_kissed:
            stop music fadeout 1.0
            play music "creep.mp3"
            scene bg ok end ha
            pause
            ...
            stop music fadeout 1.0
            return
        elif warren_end and alexei_end and warren_kissed and alexei_kissed and not honey_kissed:
            stop music fadeout 1.0
            play music "creep.mp3"
            scene bg ok end wa
            pause
            ...
            stop music fadeout 1.0
            return
        elif warren_end and warren_kissed and not alexei_kissed and warren_kissed and not honey_kissed:
            stop music fadeout 1.0
            play music "creep.mp3"
            scene bg ok end w
            pause
            stop music fadeout 1.0
            return
        elif alexei_end and alexei_kissed and not warren_kissed and not honey_kissed:
            stop music fadeout 1.0
            play music "creep.mp3"
            scene bg ok end a
            pause
            stop music fadeout 1.0
            return
        elif honey_end and not alexei_kissed and not warren_kissed and honey_kissed:
            stop music fadeout 1.0
            play music "creep.mp3"
            scene bg ok end h
            pause
    ...
    label sad_ending:
        ...
        scene end leave
        pause
        "The thought of hurting Alexi and his career proved to much to you. You cannot be with the one you now love without destroying all that they themselves love."
